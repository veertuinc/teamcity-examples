...
object TeamcityExamples : Project({
    ...
    features {
        feature {
            ...
            param("group_id", "")
            param("profileId", "anka-8")
            param("name", "Anka General")
            param("next-hour", "")
        ...
        feature {
            ...
            """.trimIndent())
            param("auth.oidc.client_secret", "")
            param("profileServerUrl", "http://anka.teamcity:8084")
            param("total-work-time", "")
            param("auth.cert.cert", """
                -----BEGIN CERTIFICATE-----
                MIIEdTCCA10CCQCJ7Ei/xlKuWzANBgkqhkiG9w0BAQsFADB+MQswCQYDVQQGEwJV
            ...
            """.trimIndent())
            param("cloud-code", "anka")
            param("clouds.anka.maxInstances", "1")
            param("priority", "")
            param("terminate-after-build", "true")
            param("group_id", "")
            param("profileId", "anka-9")
            param("name", "Anka Secondary")
            param("next-hour", "")
            param("image_id", "cfbf3554-1360-471a-8c5d-60620f17bae6")
            param("ssh_password", "admin")
